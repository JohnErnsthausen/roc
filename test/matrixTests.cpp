...
TEST_F(TestThatMatrix,
       CanConstructAnUninitializedMatrixSepcifyingRowsColsANDInitialiseIt)
{
  matrix<int> M(4, 7);
...
// // initializer_list constructor will be used: create a 2x2 diagonal matrix
// with 1, 2 on the diagonal cout << "matrix{1, 2}:\n"; cout << matrix<int>{1,
// 2};
// // (size_t, size_t) constructor will be used: create an UNINITIALIZED 1x2
// matrix cout << "matrix(1, 2):\n"; cout << matrix<int>(1, 2);
