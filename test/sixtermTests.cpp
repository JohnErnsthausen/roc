...
TEST(
    SixTermAnalysisOf,
    TaylorSeriesAtNegativePT3ComplexConjugatePolesAtPMOneFifthIWithScalingTenthAlphaOne)
{
  // t =-0.3;
  ...
  vector<double> coeffs{
      0.307692307692308,      0.142011834319527,     0.0418752844788348,
      0.00840306711949862,    0.000657162941396686,  -0.000343083805470654,
      -0.000208897367247739,  -7.00231075396755e-05, -1.6249329076178e-05,
      -2.11329745518403e-06,  2.74580334236446e-07,  2.8929072773867e-07,
      1.12397233245813e-07,   2.96225132104777e-08,  5.02598815515791e-09,
      4.1031978497680128e-11,  // 4.10319784976749e-11;
      -3.67676637243989e-10,  -1.72853215535509e-10, -5.14955889206971e-11,
      -1.04707936914365e-11,  -8.7147486368628e-13,  4.03226500716829e-13,
      2.5314106676825e-13,    8.58169153763594e-14,  2.01354173453774e-14,
      2.69196836122347e-15,   -3.06431321387433e-16, -3.48504329965235e-16,
      -1.37276512184922e-16,  -3.65503648572534e-17};
  ...
  for (int i = 0; i < 3; i++) printf("b[%d] = [%22.16f]\n", i, x[ ipiv[ i ] ]);
