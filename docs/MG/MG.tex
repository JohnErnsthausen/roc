...
\begin{description}
  \item[\aclabel{acIN}] Handle input acquisition.
    % \item[\aclabel{acIHardware}] Handle input acquisition via hardware.
    % \item[\aclabel{acISoftware}] Handle input acquisition via software.
    % \item[\aclabel{acIFormat}] Validate input format.
    % \item[\aclabel{acIType}] Validate input type.
  \item[\aclabel{acOUT}] Handle output.
    % \item[\aclabel{acOHardware}] Handle output via hardware.
    % \item[\aclabel{acOSoftware}] Handle output via software.
    % \item[\aclabel{acOFormat}] Handle output format.
    % \item[\aclabel{acOType}] Handle output type.
  \item[\aclabel{acPARAM}] Handle parameter acquisition.
    % \item[\aclabel{acPFormat}] Handle parameter format.
    % \item[\aclabel{acPType}] Handle parameter type.
    % \item[\aclabel{acPDistribution}] Handle parameter distribution.
    % \item[\aclabel{acPConstraints}] Handle parameter constraints.
  \item[\aclabel{acSOLVER}] Algorithms.
    % \item[\aclabel{acPoleRealSolverAlgorithm}] Algorithm to find the distance to the nearest real pole.
    % \item[\aclabel{acPoleComplexSolverAlgorithm}] Algorithm to find the distance to the nearest complex conjugate pair of poles.
    % \item[\aclabel{acPoleComplicatedAlgorithm}] Algorithm to find the distance to the nearest pole in hard to resolve case.
  \item[\aclabel{acPoleRealSolver}] Find the distance to the nearest real pole.
  \item[\aclabel{acPoleComplexSolver}] Find the distance to the nearest complex conjugate pair of poles.
  \item[\aclabel{acPoleTopLine}] Find the distance to the nearest pole in hard to resolve case.
  \item[\aclabel{acROC}] Pole identification, distinguish a real pole from a complex conjugate pair of poles
...
\begin{description}
  \item[\mlabel{mIN}] Input module.
  \item[\mlabel{mOUT}] Output module.
  \item[\mlabel{mPARAM}] Parameter module.
  \item[\mlabel{mSOLVER}] Solver module.
  \item[\mlabel{mPoleRealSolver}] Real pole module.
  \item[\mlabel{mPoleComplexSolver}] Complex conjugate pair of poles module.
  \item[\mlabel{mPoleTopLineSolver}] Resolve nearest pole in hard to resolve case module.
  \item[\mlabel{mROC}] Pole identification module.
\end{description}
